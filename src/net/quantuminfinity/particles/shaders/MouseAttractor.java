...
public class MouseAttractor extends ComputeShader
{
	public PingPongFBO fbo;
	
	public MouseAttractor(int textureSize)
	{
		super(textureSize, "/shaders/compute/mouseattractor.frag", "/shaders/compute/mouseattractor.vert");
	}
